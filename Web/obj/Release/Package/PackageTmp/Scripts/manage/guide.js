...
$.ready(function () {
    ...
    var guideItems=[{
        ...
        children: [{
            text: "新闻分类",
            ico: "ico0",
            href: "/Manage/News/NewsCates.html"
        },{
            text: "新闻编辑",
            ico: "ico1",
            href: "/Manage/News/News.html"
        }]
    },{
        text: "产品",
        children: [{
            text: "产品分类",
            ico: "ico0",
            href: "/Manage/Product/ProductCates.html"

        },{
            text: "产品管理",
            ico: "ico1",
            href: "/Manage/Product/Products.html"
        },{
            text: "商品评论",
            selected: true,
            ico: "ico7",
            href: "/Manage/Product/Comments.html"
        }]
        ...
        children: [{
            text: "分类管理",
            ico: "ico0",
            href: "/Manage/Package/Categories.html"

        },{
            text: "楼盘管理",
            ico: "ico6",
            href: "/Manage/Package/Buildings.html"
        },{
            text: "套餐管理",
            ico: "ico1",
            href: "/Manage/Package/Packages.html"
        },{
            text: "照片展示",
            selected: true,
            ico: "ico7",
            href: "/Manage/Photo/Photos.html"
        }]
        ...
        children: [{
            text: "订单管理",
            ico: "ico0",
            href: "/Manage/Order/Orders.html"

        },{
            text: "快递管理",
            ico: "ico7",
            href: "/Manage/Express/ExpressList.html"
        ...
        children: [{
            text: "首页设置",
            ico: "ico0",
            href: "/Manage/Media/Index.html"

        },{
            text: "产品页",
            ico: "ico6",
            href: "/Manage/Media/Products.html"

        },{
            text: "购物车",
            ico: "ico8",
            href: "/Manage/Media/Cart.html"

        },{
            text: "友情链接",
            ico: "ico9",
            href: "/Manage/FriendLink/FriendLinks.html"
