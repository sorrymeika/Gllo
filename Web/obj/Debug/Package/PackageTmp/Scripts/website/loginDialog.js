function LoginDialog(url) {
    ...
    $("IMG",dd).css({ "float": "left","margin": "0px 0px 0px 10px","cursor": "pointer" }).prop("id","__login_cc").on("click",function () {
        changeCheckCode("__login_cc");
    });
    ...
    $("IMG",dd).css({ "float": "left","margin": "0px 0px 0px 10px","cursor": "pointer" }).prop("id","__reg_cc").on("click",function () {
        changeCheckCode("__reg_cc");
    });
        ...
        success: function () {
            ...
            $.post("/User/IsRegist/",function (res) {
                if(res.success) {
                    ...
                    regName.msg.css("err").html(res.msg);
